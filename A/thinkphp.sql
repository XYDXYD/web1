...
CREATE TABLE `think_activities` (
  `acs_id` int(11) unsigned NOT NULL,
...
--
-- Table structure for table `think_award`
--

DROP TABLE IF EXISTS `think_award`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `think_award` (
...
--
-- Dumping data for table `think_award`
--

LOCK TABLES `think_award` WRITE;
/*!40000 ALTER TABLE `think_award` DISABLE KEYS */;
/*!40000 ALTER TABLE `think_award` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `think_award_type` VALUES (1,'红棉奖',NULL),(2,'先进个人',NULL),(3,'精品项目',NULL),(4,'先进团队',NULL);
...
-- Dump completed on 2013-05-14  3:09:49
