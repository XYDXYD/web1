	        ...
	        <div class="span10 offset1">
	            <table class="table table-condensed">
                    ...
                    <?php if(is_array($activity)): $i = 0; $__LIST__ = $activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$record): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a class="btn btn-mini btn-danger" href="__URL__/delete/id/<?php echo ($record["ac_id"]); ?>">删除</a>
                            <a class="btn btn-mini btn-info" href="__URL__/edit/id/<?php echo ($record["ac_id"]); ?>">编辑</a>
                            <?php if($record["status"] == 0): ?><a class="btn btn-mini btn-success" href="__URL__/publish/id/<?php echo ($record["ac_id"]); ?>">发布</a>
                            <?php else: ?>
